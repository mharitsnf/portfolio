                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[4vh] lg:gap-[6vh]">
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly lg:text-[1.5vw]">A puzzle game developed for GMTK Game Jam 2021 in Godot Engine. Players have to navigate through the maze by moving around the level. Each time the character moves, his movement will be recorded and should be used in one shot after three moves were recorded.</p>

                                <div className="flex flex-col font-print-clearly gap-[1vh]">
                                    <p className="font-print-bold lg:text-[1.5vw]">Ranks (out of number of entries):</p>
                                    <div className="grid text-[4vw] lg:text-[1.5vw]">
                            ...
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly lg:text-[1.5vw]">A turn-based game developed for GMTK Game Jam 2020. The player must win a tourament by performing series of actions such as heal and attack while maintaining their relationship with the character's inner "voice". If they do not have a good relationship, the character might perform their own actions instead of listening to the player and vice versa.</p>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[4vh]">
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly lg:text-[1.5vw]">Animeet is an anime visualization tool that allows the users to explore and discover animes based on their similarities and other attributes such as rank and rating. The tool is interactive and equipped with filters and brushes.</p>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[4vh]">
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly lg:text-[1.5vw]">Researched suitable image features for hand gesture recognition especially used for SIBI (Sistem Isyarat Bahasa Indonesia) inflectional word gestures, using a single RGB smartphone camera. The features extracted are Elliptical Fourier Descriptor, Centroid, and Area. The features will be used for training and testing a 2-layer Long Short-Term Memory (LSTM) model.</p>
