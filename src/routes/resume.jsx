                ...
                <div className="flex flex-col gap-[8vh]">
                    <div>
                        ...
                        <div className="flex flex-col gap-[4vh]">
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly text-[4vw] lg:text-[1.5vw]">May 2020 - August 2021</p>
                                <p className="font-print-clearly lg:text-[1.5vw]">
                            ...
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly text-[4vw] lg:text-[1.5vw]">April 2019 - May 2020 • Jakarta, Indonesia • Full-Time</p>
                                <div className="flex flex-col gap-[2vh] lg:text-[1.5vw]">
                            ...
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly text-[4vw] lg:text-[1.5vw]">January 2018 - February 2018 • Bandung, Indonesia • Internship</p>
                                <div className="flex flex-col gap-[2vh] lg:text-[1.5vw]">
                                    <p className="font-print-bold">Key responsibilities:</p>
                                    <div className="font-print-clearly">
                            ...
                            <div className="flex flex-col gap-[2vh]">
                                ...
                                <p className="font-print-clearly text-[4vw] lg:text-[1.5vw]">June 2017 - September 2017 • Jakarta, Indonesia • Internship</p>
                                <div className="flex flex-col gap-[2vh] lg:text-[1.5vw]">
                                    <p className="font-print-bold">Key responsibilities:</p>
                                    <div className="font-print-clearly">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[2vh]">
                            <div className="flex flex-col">
                                ...
                                <p className="font-print-bold lg:text-[1.5vw]">KTH Royal Institute of Technology</p>
                                <p className="font-print-clearly lg:text-[1.5vw]">August 2021 - Now</p>
                            </div>
                            <div className="flex flex-col">
                                <Header3>B.Sc Computer Science</Header3>
                                <p className="font-print-bold lg:text-[1.5vw]">Universitas Indonesia</p>
                                <p className="font-print-clearly lg:text-[1.5vw]">September 2014 - January 2019</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-[1vh]">
                            ...
                            <p className="font-print-bold lg:text-[1.5vw]">Sorted by comfortability</p>
                            <div className="flex flex-wrap font-print-clearly gap-x-[4vw] gap-y-[1.5vh] justify-start lg:text-[1.5vw]">
                                <p>JavaScript</p>
                                <p>Godot / GDScript</p>
                                <p>HLSL</p>
                                <p>C++</p>
